...
export async function getImages(int, type, orientation) {
  const response = await fetch(
    `https://api.unsplash.com/search/photos?query=${type}&orientation=${orientation}&per_page=${int}10&client_id=${accessKey}`
  );
...
export const displayNav = (data) => {
  let logoPath =
    "https://ik.imagekit.io/tfotr241290/Black_n_White_Luxury__Rent_Car_Logo.png?updatedAt=1679597309897";
