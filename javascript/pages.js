    ...
    <main>
        <form action="thankyou.html" class="checkout-form">
            ...
            <fieldset class="payment-form">
                ...
                <label class="top" for="cc-number">Card number<input id="cc-number" name="cc-number" autocomplete="cc-number" inputmode="numeric" maxlength="18" pattern="{13,18}" required></label>
                <label class="top" for="cc-name">Name on card<input id="cc-name" name="cc-name" autocomplete="cc-name" maxlength="50" required></label>
